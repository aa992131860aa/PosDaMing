...
public class StockOutOtherActivity extends BaseActivity implements View.OnClickListener, StockInOtherAdapter.OnEditChangeListener, BillTypePopup.OnItemClickListener {
    ...
    //是否保存
    private boolean isSaveOutOther = false;
    ...
    protected void initView(Bundle savedInstanceState) {
        setContentView(R.layout.activity_stock_out_other);
    ...
    protected void initData() {
        ...
        isSaveOutOther = SharePreUtils.getBoolean("isSaveOutOther", false, this);


        if (isSaveOutOther) {
            //mOrderSave = SharePreUtils.getString("orderOutOther", "", this);
            mSaveLists = DataSupport.where("type=?", "orderOutOther").find(Material.class);
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (wareListJson.isIs_success()) {
                    ...
                    ToastUtil.show("获取交货单位失败,请重新获取", StockOutOtherActivity.this);
                }
            }
...
//    }
    ...
    private void submit() {
        ...
        params.addParameter("method", "placing.other.add");
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (dataJson.isIs_success()) {
                    SharePreUtils.putBoolean("isSaveOutOther", false, StockOutOtherActivity.this);
                    ToastUtil.show("出库成功", StockOutOtherActivity.this);
                    finish();
                } else {
                    if (!TextUtils.isEmpty(dataJson.getMsg())) {
                        ToastUtil.show(dataJson.getMsg(), StockOutOtherActivity.this);
                    } else {
                        ToastUtil.show("出库失败", StockOutOtherActivity.this);
                    }
                }
            }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_scan:
                ...
                if (ContextCompat.checkSelfPermission(StockOutOtherActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    // Do not have the permission of camera, request it.
                    ActivityCompat.requestPermissions(StockOutOtherActivity.this, new String[]{Manifest.permission.CAMERA}, REQ_CODE_PERMISSION);
                } else {
            ...
            //保存
            case R.id.btn_save:
                SharePreUtils.putBoolean("isSaveOutOther", true, this);
                //SharePreUtils.putString("orderOutOther", edt_no.getText().toString(), this);
                DataSupport.deleteAll(Material.class, "type = ?", "orderOutOther");
                if (orderitemsBeans.size() > 0) {
                    for (int i = 0; i < orderitemsBeans.size(); i++) {
                        Material material = new Material();
                        material.setType("orderOutOther");
    ...
    private void startCaptureActivityForResult() {
        Intent intent = new Intent(StockOutOtherActivity.this, CaptureActivity.class);
        ...
        switch (requestCode) {
            case REQ_CODE_PERMISSION: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    ToastUtil.show("请在app设置界面开启照相权限", StockOutOtherActivity.this);
                }
            }
            break;
        }
            ...
            case CaptureActivity.REQ_CODE:
                switch (resultCode) {
                    case RESULT_OK:
                        ...
                        //ToastUtil.show(result, StockOutOtherActivity.this);
                        getItem(result, -1);
                    ...
                    case RESULT_CANCELED:
                        ...
                        ToastUtil.show("取消扫描", StockOutOtherActivity.this);
                        break;
                }
                break;
        }
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (materialItemJson.isIs_success()) {
                    ...
                    ToastUtil.show("没有该物料。", StockOutOtherActivity.this);
                }
